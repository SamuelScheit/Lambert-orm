	...
	init() {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (localServer) {
				...
				if (!fs_1.default.existsSync(dbPath)) fs_1.default.mkdirSync(dbPath);
	...
	destroy() {
		...
		return __awaiter(this, void 0, void 0, function* () {
			yield Promise.all([
				...
				(_b = this.mongod) === null || _b === void 0 ? void 0 : _b.stop(),
			]);
		});
	}
}
		...
		if (this.updatepath) {
			return this.checkIfModified(
				this.collection.updateOne(
					...
					Object.assign(Object.assign({}, this.options), { arrayFilters: this.arrayFilters })
				)
			);
		}
